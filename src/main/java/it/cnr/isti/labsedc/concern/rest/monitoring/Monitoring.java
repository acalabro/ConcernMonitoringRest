...
//    			+ " <button onclick=\"show()\">Show/Hide log window</button>\n<br /><br />"
				...
				+"<br /><br /><button id=\"notificationButton\" onclick=\"notificationFunction()\">Notifications</button><br /></div>"
    			+ "<div class=\"column\"> </div>"
				+"</div>"		
				+ "    	<script>\n"
				...
				+ "    	    window.open(\"./biecointerface/notifications\", \"_blank\", \"toolbar=yes,scrollbars=yes,resizable=yes,top=500,left=500,width=700,height=400\");\n"
				+ "    	}\n"
				+ "    	</script>"
				+ "    	<script>\n"
